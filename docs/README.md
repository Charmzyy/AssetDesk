...
**Last updated:** 2026-07-06 · **App version at time of writing:** 6.12.0 (development)
...
2. **Portal customers and agents** then see a filtered, paginated, searchable table
   ...
   and XLSX/PDF export.
3. **Agents** additionally get a CSV import panel on tickets: attach a CSV, and each
   row is created or updated as an Assets object.
...
└── src/
    ...
    │   └── CsvImportPanel.jsx    # AGENT — CSV import issue panel
    ├── resolvers/
    ...
    │   ├── csvImport.js          # CSV import resolvers (preview, start, poll)
    │   ├── csvImportConsumer.js  # queue consumer: row-by-row create/update
